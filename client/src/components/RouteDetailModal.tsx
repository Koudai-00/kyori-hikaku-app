                  ...
                  <Button 
                    onClick={() => {
                      ...
                      if (mapElement.__mapInstance) {
                        ...
                        console.log('テスト: 既存の地図インスタンスを使用');
                      } else {
                        console.log('テスト: 新しい地図インスタンスを作成');
                      ...
                      console.log('テスト: ルート計算開始', request);
                      
                      // ルートを計算して表示
                      directionsService.route(request, (result, status) => {
                        if (status === window.google.maps.DirectionsStatus.OK && result) {
                          console.log('テスト: ルート計算成功');
                          ...
                          console.log('テスト: ルート計算失敗', status);
                        }
                      });
                    }}
                    variant="outline" 
